...
const usersRef = dbRef.child('online');
...
function userClicked(e) {
	...
	var ast="";
	const userRef = dbRef.child('online/' + psd);
		...
		if (window.sessionStorage) 
				{
					...
					var myWindow = window.open("");
  					myWindow.document.write("<title>Technova || Annual Tech Fest</title><iframe width='100%' height='100%' src='login.html' frameborder='0' allowfullscreen></iframe>");
				}
	}
	else
	{
