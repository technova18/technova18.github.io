function getParams(){
	    ...
	    cnt = 0;
            $("#clsdtls").html("Details of <b>Inter College </b>Students Registered<br>");
...
var ffood = snap.child("ffood").val();
var sfood = snap.child("sfood").val();
var appid = snap.child("appid").val();
var prtype = snap.child("prtype").val();

if(prtype=="Inter")
{
$("#table_body").append("<tr><td>" + appid + "</td><td>" + fname + "</td><td>" + sname + "</td><td>" + fmail + "</td><td>" + smail + "</td><td>" + fphone + "</td><td>" + sphone + "</td><td>" + fstrm + "</td><td>" + sstrm + "</td><td>" + fyr + "</td><td>" + syr + "</td><td>" + fclg + "</td><td>" + sclg + "</td><td>" + fdept + "</td><td>" + sdept + "</td><td>" + fevent + "</td><td>" + sevent + "</td><td>" + mindbend + "</td><td>" + tfevent + "</td><td>" + tsevent + "</td><td>" + ffood + "</td><td>" + sfood + "</td></tr>");
}
