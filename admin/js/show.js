function getParams(){
	    ...
	    cnt = 0;
            $("#clsdtls").html("Details of Students Registered for <b>Offline Show </b><br>");
...
var rootRef = firebase.database().ref('show');
...
$("#table_body").append("<tr><td>" + appid + "</td><td>" + fname + "</td><td>" + fmail + "</td><td>" + fphone + "</td><td>" + fstrm + "</td><td>" + fyr + "</td><td>" + fclg + "</td><td>" + fdept + "</td><td>" + fevent + "</td><td>" + sevent + "</td><td>" + tevent + "</td><td>" + hevent + "</td></tr>");
